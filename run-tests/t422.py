# a list of the numbers that Skulpt has trouble rounding correctly; all
...
print("\n-649 to -250, ndigit=-2")
helper(list(range(-250, -350, -1)), -300, -2)
helper(list(range(-350, -450, -1)), -400, -2)
helper(list(range(-450, -550, -1)), -500, -2)
helper(list(range(-550, -650, -1)), -600, -2)

print("\n250 to 649, ndigit=-2")
helper(list(range(250, 350)), 300, -2)
helper(list(range(350, 450)), 400, -2)
helper(list(range(450, 550)), 500, -2)
helper(list(range(550, 650)), 600, -2)
