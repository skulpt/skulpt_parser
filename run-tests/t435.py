...
print("\nx in s")
print((4 in s1) == (4 in s2))
print((8 in s1) == (1 in s2) == False)

print("\nx not in s")
print((1 not in s1) == (8 not in s2) == False)
print((8 not in s1) == (1 not in s2))

print("\nisdisjoint(other)")
print(s1.isdisjoint(s2) == False)
print(s1.isdisjoint(set(range(5, 10))))
...
empty = set([])
empty.intersection_update(s1)
print(empty == set([]))
empty = s1.copy()
empty.intersection_update(set([]))
print(empty == set([]))
empty = s1.copy()
empty.intersection_update(s2)
print(empty == set([4]))
empty = s.copy()
empty.intersection_update(s1, s2)
print(empty == set([4]))

print("\ndifference(other,...)")
empty = set([])
empty.difference_update(s1)
print(empty == set([]))
empty = s1.copy()
empty.difference_update(set([]))
print(empty == s1)
empty.difference_update(s2)
print(empty == set([0, 1, 2, 3]))
empty = s.copy()
empty.difference_update(s1, s2)
print(empty == set([]))

print("\nsymmetric_difference_update(other)")
empty = set([])
empty.symmetric_difference_update(s1)
print(empty == s1)
empty.symmetric_difference_update(set([]))
print(empty == s1)
empty.symmetric_difference_update(s2)
print(empty == set([0, 1, 2, 3, 5, 6, 7, 8]))
...
print(empty == set([]))
s1.remove(5)
print(s1 == set([0, 1, 2, 3, 4]))

print("\ndiscard(elem)")
empty.discard(500)
print(empty == set([]))
s1.discard(4)
print(s1 == set([0, 1, 2, 3]))
