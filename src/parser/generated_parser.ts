...
import { logger, memoize, memoize_left_rec, Parser } from "./parser";
...
export class GeneratedParser extends Parser {
  ...
  assignment() {
    ...
    if (
      ...
      return CHECK_VERSION(
        ...
        new astnodes.AnnAssign(a, b, c, 0, ...EXTRA),
      );
    }
    this.reset(mark);
    if (
  ...
  import_from() {
    ...
    if (
      ...
      return new astnodes.ImportFrom(
        b.id,
        c,
        pegen.seq_count_dots(a),
        ...EXTRA,
      );
    }
    this.reset(mark);
  ...
  for_stmt() {
    ...
    if (
      ...
      return CHECK_VERSION(
        5,
        "Async for loops are",
        new astnodes.AsyncFor(t, ex, b, el, NEW_TYPE_COMMENT(tc), ...EXTRA),
      );
    }
    this.reset(mark);
    if (cut) return null;
  ...
  with_stmt() {
    ...
    if (
      ...
      return CHECK_VERSION(
        ...
        new astnodes.AsyncWith(a, b, null, ...EXTRA),
      );
    }
    this.reset(mark);
    if (
      ...
      return CHECK_VERSION(
        5,
        "Async with statements are",
        new astnodes.AsyncWith(a, b, NEW_TYPE_COMMENT(tc), ...EXTRA),
      );
    }
    this.reset(mark);
  ...
  star_expressions() {
    ...
    if (
      ...
      return new astnodes.Tuple(
        (pegen.seq_insert_in_front(a, b)),
        new astnodes.Load(),
        ...EXTRA,
      );
    }
  ...
  lambdef() {
    ...
    if (
      ...
      return new astnodes.Lambda(
        (a) ? a : (pegen.empty_arguments(p)),
        b,
        ...EXTRA,
      );
    }
  ...
  term() {
    ...
    if (
      ...
      return CHECK_VERSION(
        5,
        "The '@' operator is",
        new astnodes.BinOp(a, new astnodes.MatMult(), b, ...EXTRA),
      );
    }
    this.reset(mark);
    if (
  ...
  atom() {
    ...
    this.reset(mark);
    if (
      (literal = this.expect("__peg_parser__"))
    ) {
  ...
  for_if_clause() {
    ...
    if (
      ...
      return CHECK_VERSION(
        ...
        new astnodes.comprehension(a, b, c, 1),
      );
    }
    this.reset(mark);
    if (cut) return null;
  ...
  kwarg_or_starred() {
    ...
    if (
      ...
      return pegen.keyword_or_starred(
        (new astnodes.keyword(a.id, b, ...EXTRA)),
        1,
      );
    }
    this.reset(mark);
  ...
  kwarg_or_double_starred() {
    ...
    if (
      ...
      return pegen.keyword_or_starred(
        (new astnodes.keyword(null, a, ...EXTRA)),
        1,
      );
    }
    this.reset(mark);
  ...
  star_target() {
    ...
    this.reset(mark);
    if (
      (target_with_star_atom = this.target_with_star_atom())
    ) {
  ...
  single_target() {
    ...
    mark = this.mark();
    if (
      (single_subscript_attribute_target = this
  ...
  invalid_arguments() {
    ...
    if (
      ...
      return pegen.RAISE_SYNTAX_ERROR(
  ...
  invalid_kwarg() {
    ...
    mark = this.mark();
    if (
      this.negative_lookahead(this._tmp_126) &&
      (a = this.expression()) &&
      (b = this.expect("="))
    ) {
      return pegen.RAISE_SYNTAX_ERROR_KNOWN_LOCATION(
