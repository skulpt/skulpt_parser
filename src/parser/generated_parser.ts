...
export class GeneratedParser extends Parser {
    ...
    type_expressions(): any | null {
        ...
        let _gather_9, a, b, c, literal, literal_1, literal_2, literal_3, mark;
        mark = this.mark();
        if (
            (a = this._gather_3()) &&
            (literal = this.expect(",")) &&
    ...
    statement_newline(): any | null {
        ...
        let a, endmarker, mark, newline, simple_stmt;
        mark = this.mark();
    ...
    assignment(): stmt | null {
        ...
        if (
            ...
            return CHECK_VERSION(
                ...
                new astnodes.AnnAssign(pegen.set_expr_context(a, new astnodes.Store()), b, c, 1, ...EXTRA)
            );
        }
        this.reset(mark);
        if (
        ...
        if (
            ...
            return new astnodes.Assign(a, b, pegen.NEW_TYPE_COMMENT(tc), ...EXTRA);
        }
        this.reset(mark);
    ...
    augassign(): operator | null {
        ...
        this.reset(mark);
        if ((literal = this.expect("@="))) {
            return CHECK_VERSION(5, "The '@' operator is", new astnodes.MatMult());
        }
        this.reset(mark);
        if ((literal = this.expect("/="))) {
    ...
    import_from_targets(): any | null {
        ...
        this.reset(mark);
        if ((literal = this.expect("*"))) {
            return pegen.singleton_seq(pegen.alias_for_star(p));
        }
        this.reset(mark);
    ...
    for_stmt(): stmt | null {
        ...
        if (
            ...
            return new astnodes.For(t, ex, b, el, pegen.NEW_TYPE_COMMENT(tc), ...EXTRA);
        }
        this.reset(mark);
        if (cut) return null;
        cut = false;
        if (
            ...
            return CHECK_VERSION(
                5,
                "Async for loops are",
                new astnodes.AsyncFor(t, ex, b, el, pegen.NEW_TYPE_COMMENT(tc), ...EXTRA)
            );
        }
        this.reset(mark);
        if (cut) return null;
    ...
    with_stmt(): stmt | null {
        ...
        if (
            ...
            return new astnodes.With(a, b, pegen.NEW_TYPE_COMMENT(tc), ...EXTRA);
        }
        this.reset(mark);
        if (
            (async = this.expect("ASYNC")) &&
        ...
        if (
            ...
            return CHECK_VERSION(
                ...
                new astnodes.AsyncWith(a, b, pegen.NEW_TYPE_COMMENT(tc), ...EXTRA)
            );
        }
        this.reset(mark);
    ...
    block(): any | null {
        ...
        let a, dedent, indent, invalid_block, mark, newline, simple_stmt;
        mark = this.mark();
        if (
            (newline = this.expect("NEWLINE")) &&
    ...
    kwarg_or_starred(): KeywordOrStarred | null {
        ...
        if ((a = this.name()) && (literal = this.expect("=")) && (b = this.expression())) {
            return pegen.keyword_or_starred(new astnodes.keyword(a.id, b, ...EXTRA), 1);
        }
        this.reset(mark);
    ...
    kwarg_or_double_starred(): KeywordOrStarred | null {
        ...
        this.reset(mark);
        if ((literal = this.expect("**")) && (a = this.expression())) {
            return pegen.keyword_or_starred(new astnodes.keyword(null, a, ...EXTRA), 1);
        }
        this.reset(mark);
        if ((invalid_kwarg = this.invalid_kwarg())) {
            return invalid_kwarg;
    ...
    star_targets_tuple_seq(): any | null {
        ...
        let a, b, literal, mark, opt;
        mark = this.mark();
        if ((a = this.star_target()) && (b = this._loop1_119()) && ((opt = this.expect(",")), 1)) {
            return pegen.seq_insert_in_front(a, b);
        }
        this.reset(mark);
    ...
    star_target(): expr | null {
        ...
        let a, literal, mark, target_with_star_atom;
        mark = this.mark();
        if ((literal = this.expect("*")) && (a = this._tmp_120())) {
            return new astnodes.Starred(
                pegen.set_expr_context(a, new astnodes.Store()),
                new astnodes.Store(),
                ...EXTRA
            );
        }
    ...
    invalid_kwarg(): any | null {
        ...
        let a, b, mark;
        mark = this.mark();
        if (this.negative_lookahead(this._tmp_126) && (a = this.expression()) && (b = this.expect("="))) {
    ...
    invalid_assignment(): any | null {
        ...
        let _loop0_127, _loop0_128, _loop0_129, _tmp_130, a, augassign, expression, literal, literal_1, mark;
        mark = this.mark();
        if (
        ...
        this.reset(mark);
        if ((_loop0_128 = this._loop0_128()) && (a = this.star_expressions()) && (literal = this.expect("="))) {
            return pegen.RAISE_SYNTAX_ERROR_INVALID_TARGET(STAR_TARGETS, a);
        }
        this.reset(mark);
        if ((_loop0_129 = this._loop0_129()) && (a = this.yield_expr()) && (literal = this.expect("="))) {
            return pegen.RAISE_SYNTAX_ERROR_KNOWN_LOCATION(a, "assignment to yield expression not possible");
        }
        this.reset(mark);
        if ((a = this.star_expressions()) && (augassign = this.augassign()) && (_tmp_130 = this._tmp_130())) {
            return pegen.RAISE_SYNTAX_ERROR_KNOWN_LOCATION(
                a,
    ...
    invalid_comprehension(): any | null {
        ...
        let _tmp_131, a, for_if_clauses, mark;
        mark = this.mark();
        if (
    ...
    invalid_parameters(): any | null {
        ...
        let _loop0_132, _tmp_133, mark, param_no_default;
        mark = this.mark();
        if (
    ...
    invalid_lambda_parameters(): any | null {
        ...
        let _loop0_134, _tmp_135, lambda_param_no_default, mark;
        mark = this.mark();
        if (
            (_loop0_134 = this._loop0_134()) &&
    ...
    invalid_star_etc(): any | null {
        ...
        let _tmp_136, literal, literal_1, mark, type_comment;
        mark = this.mark();
    ...
    invalid_lambda_star_etc(): any | null {
        ...
        let _tmp_137, literal, mark;
        mark = this.mark();
        if ((literal = this.expect("*")) && (_tmp_137 = this._tmp_137())) {
            return pegen.RAISE_SYNTAX_ERROR("named arguments must follow bare *");
        }
        this.reset(mark);
    ...
    _loop0_106(): any | null {
        ...
        mark = this.mark();
        children = [];
        while ((literal = this.expect(",")) && (elem = this._tmp_148())) {
            children.push(elem);
            mark = this.mark();
        }
        this.reset(mark);
    ...
    _gather_105(): any | null {
        ...
        let elem, mark, seq;
        mark = this.mark();
        if ((elem = this._tmp_148()) !== null && (seq = this._loop0_106()) !== null) {
            return [elem, ...seq];
        }
        this.reset(mark);
    ...
    _tmp_126(): any | null {
        //# _tmp_126: NAME '='
        let literal, mark, name;
        mark = this.mark();
        if ((name = this.name()) && (literal = this.expect("="))) {
            return name, literal;
        }
        this.reset(mark);
    ...
    _tmp_133(): any | null {
        ...
        let _loop1_153, mark, slash_with_default;
        mark = this.mark();
    ...
    _tmp_135(): any | null {
        ...
        let _loop1_154, lambda_slash_with_default, mark;
        mark = this.mark();
    ...
    _tmp_137(): any | null {
        //# _tmp_137: ':' | ',' (':' | '**')
        let _tmp_156, literal, mark;
        mark = this.mark();
        if ((literal = this.expect(":"))) {
            return literal;
        }
        this.reset(mark);
        if ((literal = this.expect(",")) && (_tmp_156 = this._tmp_156())) {
