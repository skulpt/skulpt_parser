...
import { DEDENT, ENDMARKER, INDENT, NAME, NEWLINE, NUMBER, OP, STRING, EXACT_TOKEN_TYPES } from "../tokenize/token.ts";
...
import { FSTRING_INPUT, KeywordToken, StartRule, TARGETS_TYPE } from "./pegen_types.ts";
...
export class Parser {
    ...
    raise_error_known_location(
        ...
        if (this.start_rule === FSTRING_INPUT) {
            /** @todo */
        }
